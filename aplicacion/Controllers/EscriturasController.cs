...
namespace aplicacion.Controllers
{
    public class EscriturasController : Controller
    {
        ...
        public double searchPercentProperty(List<Multipropietario> Propetarios, List<string> porcentajes)
        {
            var percents = porcentajes.ConvertAll(double.Parse);
            ...
            if (escritura.Cne == "compraventa")
            {
                ...
                if (EnajenateRun.Count() == 1 &&  AdquirienteRun.Count() == 1 )
                {
                    if (DifSumPercentAdquiriente != 0 && DifSumPercentAdquiriente != 100)
                    {
                        ...
                        EnajenantePorcentajeDerecho[0] = EnajenantePorcentajeDerecho[0] + DifSumPercentAdquiriente;
